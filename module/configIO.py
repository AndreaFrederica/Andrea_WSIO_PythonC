...
from module.router import initRegister
import pyjson5
...
class Config():
    ...
    def __getConfigFileObj(self, mode:str) -> object:
        self.file_obj = open(self.config_path, mode=mode , encoding=config.encode)
    ...
    def commit(self) -> None:
        self.__getConfigFileObj("w+")
        self.file_obj.write(json.dumps(self.config, sort_keys=True, indent=4, separators=(',', ':')))
        self.file_obj.close()
